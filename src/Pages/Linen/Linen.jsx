...
import productImage1 from "../../assets/li1.webp";
import productImage2 from "../../assets/li11.webp";
import productImage3 from "../../assets/li222.jpg";
import productImage4 from "../../assets/li22.jpg";
import productImage5 from "../../assets/li3.webp";
import productImage6 from "../../assets/li33.jpg";
import productImage7 from "../../assets/li4.jpg";
import productImage8 from "../../assets/li44.jpg";
import productImage9 from "../../assets/li5.jpg";
import productImage10 from "../../assets/li55.webp";
import productImage11 from "../../assets/li6.jpg";
import productImage12 from "../../assets/li66.jpg";
import productImage13 from "../../assets/li7.jpg";
import productImage14 from "../../assets/li77.jpg";
import productImage15 from "../../assets/li8.jpg";
import productImage16 from "../../assets/li88.jpg";
    ...
    <section className="min-h-screen bg-white px-4 md:px-28">
      ...
      <div className="flex flex-col p-6 lg:flex-row">
        ...
        <div className="flex-grow">
          <p className="mt-10 text-2xl font-bold">Linen</p>
