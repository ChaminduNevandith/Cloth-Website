...
function AddDetails() {
  ...
  return (
    <div className="w-full md-w-[600px] mx-auto mt-10 p-6 bg-white ">
      {/* Contact Section */}
      ...
      <div className="flex items-center mb-4">
        ...
        <label htmlFor="newsletter" className="text-gray-700 text-[14px]">Email me with news and offers</label>
      </div>

      {/* Delivery Section */}
      <h2 className="text-xl font-semibold mb-4 ">Delivery</h2>
      <div className="mb-4">
        <label className="block text-gray-700 text-[14px]">Country/Region</label>
      ...
      <div className="mb-4">
        <label className="block text-gray-700 text-[14px]">Apartment, Suite, etc. (optional)</label>
        <input
          type="text"
          className="w-full px-4 py-2 border rounded-md h-[50px]"
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        ...
        <div>
          <label className="block text-gray-700 text-[14px]">Postal Code (optional)</label>
          <input
            type="text"
            className="w-full px-4 py-2 border rounded-md h-[50px]"
      ...
      <div className="flex items-center">
        ...
        <label htmlFor="save-info" className="text-gray-700 text-[14px]">Save this information for next time</label>
      </div>
  ...
  <div className="border border-black rounded-md p-4 ">
    ...
    />
    <label htmlFor="koko" className="text-gray-700 text-[14px]">Koko: Buy Now Pay Later</label>
  ...
  <div className="border border-black rounded-md p-4 ">
    ...
    />
    <label htmlFor="onepay" className="text-gray-700 text-[14px]">Onepay</label>
  ...
  <div className="border border-black rounded-md p-4 ">
    ...
    />
    <label htmlFor="mintpay" className="text-gray-700 text-[14px]">Mintpay | Shop Now Pay Later</label>
  ...
  <div className="border border-black rounded-md p-4">
    ...
    />
    <label htmlFor="bank" className="text-gray-700 text-[14px]">Bank Deposit</label>
    {selectedPayment === 'Bank Deposit' && (
        ...
        <div className="border border-gray-300 rounded-md">
          <div className="p-4">
            <input
              ...
              className="mr-2"
            />
            <label htmlFor="sameAsShipping" className="text-gray-700 text-[14px]">
          ...
          <div className="p-4 border-t border-gray-300">
            <input
              ...
              className="mr-2"
            />
            <label htmlFor="differentBilling" className="text-gray-700 text-[14px]">
      ...
      <div className="flex justify-center space-x-4 mt-4">
        <a href="/refund-policy" className="text-gray-500 text-sm hover:text-black">Refund policy</a>
        <a href="/privacy-policy" className="text-gray-500 text-sm hover:text-black">Privacy policy</a>
        <a href="/terms-of-service" className="text-gray-500 text-sm hover:text-black">Terms of service</a>
      </div>
