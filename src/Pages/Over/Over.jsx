...
import productImage9 from "../../assets/ov1.jpg";
import productImage10 from "../../assets/ov11.webp";
import productImage11 from "../../assets/ov2.jpg";
import productImage12 from "../../assets/ov22.jpg";
import productImage13 from "../../assets/ov3.webp";
import productImage14 from "../../assets/ov33.jpg";
import productImage15 from "../../assets/ov4.webp";
import productImage16 from "../../assets/ov44.jpg";
    ...
    <section className="min-h-screen bg-white px-4 md:px-32">
      ...
      <div className="flex flex-col p-6 lg:flex-row">
        ...
        <div className="flex-grow">
          <p className="mt-10 text-2xl font-bold">Oversized T-Shirts</p>
