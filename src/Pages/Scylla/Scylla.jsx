...
import productImage9 from "../../assets/sc5.webp";
import productImage10 from "../../assets/sc55.webp";
import productImage11 from "../../assets/sc6.webp";
import productImage12 from "../../assets/sc66.webp";
import productImage13 from "../../assets/sc7.webp";
import productImage14 from "../../assets/sc77.webp";
import productImage15 from "../../assets/sc8.webp";
import productImage16 from "../../assets/sc88.webp";
    ...
    <section className="min-h-screen bg-white px-4 md:px-28">
      ...
      <div className="flex flex-col p-6 lg:flex-row">
        ...
        <div className="flex-grow">
          <p className="mt-10 text-2xl font-bold">Scylla Zelus</p>
